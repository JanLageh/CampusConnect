...
class SignUpScreenRiverpod extends ConsumerStatefulWidget {
  const SignUpScreenRiverpod({super.key});

  @override
  ConsumerState<SignUpScreenRiverpod> createState() =>
      _SignUpScreenRiverpodState();
}

class _SignUpScreenRiverpodState extends ConsumerState<SignUpScreenRiverpod> {
